...
BEEGPT is an open-source **agentic AI chatbot** built with **Python, FastAPI, LangGraph, LangChain, Google Gemini, Tavily, ChromaDB, and SQLite**.
...
```bash
conda create -n beegpt python=3.11 -y
```

### 4. Activate the virtual environment

```bash
conda activate beegpt
```
